...
import { businesses, businessName, money, opTime, text } from "./prototype-runtime-demo-data";
import { AttachmentThumbButton } from "./prototype-runtime-attachment-ui";
import { signedEntryAmount } from "./prototype-runtime-entry-helpers";
import { MoneyValue, NotebookRow } from "./prototype-runtime-notebook";
import type { OwnerHomeProps, PrototypeBusiness } from "./prototype-runtime-types";
...
export function OwnerHomeDayAttachments({
  ...
  loadFailed?: boolean;
  proofsCount?: number;
  onOpenOperation?: (entry: import("./prototype-runtime-types").OperationalEntry) => void;
      ...
      <div className="flex gap-3 overflow-x-auto pb-1">
        {group.items.map((item) => {
          const attachmentItem = item as {
            ...
            entry: import("./prototype-runtime-types").OperationalEntry;
          };
