...
import type { OwnerNotebookShareModalProps } from "./prototype-runtime-types";
...
export function OwnerNotebookShareModal({ lang, note, onClose }: OwnerNotebookShareModalProps) {
