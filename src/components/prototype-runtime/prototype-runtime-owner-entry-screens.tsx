...
export function OwnerSummaryScreen({
  ...
  businessesList?: import("./prototype-runtime-types").PrototypeBusiness[];
  storeChannelSettings?: import("./prototype-runtime-types").PrototypeStoreChannelSettings;
}) {
...
export function OwnerExpenseScreen({
  ...
  selectedBusiness: string;
  businessesList?: import("./prototype-runtime-types").PrototypeBusiness[];
  storeOperationalSettings?: import("./prototype-runtime-types").PrototypeStoreOperationalSettings;
}) {
  const [businessId, setBusinessId] = useState(() => {
    if (businessesList.length === 1) return businessesList[0].id;
    return selectedBusiness === "all" ? "" : selectedBusiness;
