...
import type { OwnerSettingsTeamSectionWithInvitesProps } from "./prototype-runtime-types";
...
export function OwnerSettingsTeamSectionWithInvites({
  ...
  displayBusinessName,
  rosterProps,
}: OwnerSettingsTeamSectionWithInvitesProps) {
  ...
  return (
    <>
      ...
      <OwnerSettingsTeamPendingInvites
        lang={lang}
        pendingInvites={groupedInvites.pendingInvites as import("./prototype-runtime-types").OwnerSettingsPendingInvite[]}
