...
import { OwnerNotebookScreen } from "./prototype-runtime/prototype-runtime-owner-notebook-screen";
...
export default function TaqfeelahPrototypeRuntime() {
  ...
  const closeoutAttachmentsApiEnabled = CLOSEOUTS_API_DB_SOURCE && closeoutsApiEnabled;
  ...
  const entryAttachmentsApiEnabled = ENTRIES_API_DB_SOURCE && entriesApiEnabled;
