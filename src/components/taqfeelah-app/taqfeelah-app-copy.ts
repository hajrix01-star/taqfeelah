const copy = {
  ar: {
    ...
    register: "السجل",
    ownerNotebook: "دفتري",
    targetHeatmap: "الأهداف",
    targetHeatmapTitle: "تقويم الأهداف",
    targetHeatmapHint: "تجربة شهرية تعرض مبيعات كل يوم مقابل هدف المحل.",
    dailyTarget: "الهدف اليومي",
    saveTarget: "حفظ الهدف",
    targetSaved: "تم حفظ الهدف في الخادم.",
    targetSaveFailed: "تعذر حفظ الهدف في الخادم.",
    targetBackendRequired: "لا يمكن حفظ الهدف بدون اتصال الخادم.",
    targetAchievedDays: "أيام حققت الهدف",
    targetBestDay: "أفضل يوم",
    targetAverageSales: "متوسط المبيعات",
    targetNoData: "لا توجد بيانات رسمية لهذا اليوم",
    targetServerOnly: "هذا القسم يعتمد على بيانات الخادم فقط. لا توجد أرقام محلية بديلة.",
    targetNotSet: "حدد هدفا يوميا لهذا المحل لتفعيل الألوان.",
    targetLegendNoData: "بدون بيانات",
    targetLegendLow: "أقل من 50%",
    targetLegendMedium: "50% - 74%",
    targetLegendNear: "75% - 99%",
    targetLegendMet: "حقق الهدف",
    ...
    attachmentStoredLocally: "الصورة مضغوطة ومحفوظة محليًا على هذا الجهاز",
    ...
    futureLoginOnLoginScreen: "استخدم بيانات الدخول المسجلة للمالك. طرق الواتساب/الإيميل جاهزة برمجيًا وتُفعّل لاحقًا.",
    ...
    employeePinHint: "أدخل رمز الدخول المخصص للموظف",
    ...
    qrAppNote: "رمز التطبيق — يتم ربطه حسب إعدادات المنشأة",
  ...
  en: {
    ...
    targetHeatmap: "Targets",
    targetHeatmapTitle: "Target calendar",
    targetHeatmapHint: "Monthly experiment showing each day's sales against the store target.",
    dailyTarget: "Daily target",
    saveTarget: "Save target",
    targetSaved: "Target saved on the server.",
    targetSaveFailed: "Could not save target on the server.",
    targetBackendRequired: "A server connection is required to save the target.",
    targetAchievedDays: "Days on target",
    targetBestDay: "Best day",
    targetAverageSales: "Average sales",
    targetNoData: "No official data for this day",
    targetServerOnly: "This section uses server data only. No local fallback figures are shown.",
    targetNotSet: "Set a daily target for this store to enable colors.",
    targetLegendNoData: "No data",
    targetLegendLow: "Below 50%",
    targetLegendMedium: "50% - 74%",
    targetLegendNear: "75% - 99%",
    targetLegendMet: "On target",
    ...
    attachmentStoredLocally: "Compressed image saved locally on this device",
    ...
    futureLoginOnLoginScreen: "Use the registered owner credentials. WhatsApp/email methods are code-ready and can be enabled later.",
    ...
    employeePinHint: "Enter the employee sign-in PIN",
    ...
    localDevAccess: "Local development mode",
    ...
    qrAppNote: "App code - connected from organization settings",
