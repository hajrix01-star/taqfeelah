...
const LOCAL_DEV_OWNER_USERNAME = (
  process.env.NEXT_PUBLIC_LOCAL_DEV_OWNER_USERNAME || (APP_IN_PRODUCTION_MODE ? "" : "owner")
).trim().toLowerCase();
const LOCAL_DEV_OWNER_PASSWORD = process.env.NEXT_PUBLIC_LOCAL_DEV_OWNER_PASSWORD || (APP_IN_PRODUCTION_MODE ? "" : "12345678");
