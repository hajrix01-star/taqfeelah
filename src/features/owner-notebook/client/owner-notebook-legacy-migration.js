...
export function buildOwnerNotebookNoteFingerprint(note) {
...
export function filterOwnerNotebookNotesMissingFromApi(apiNotes = [], localNotes = []) {
...
function collectOwnerNotebookStorageKeys({ organizationId = "", userId = "" } = {}) {
  const keys = new Set([
    OWNER_NOTEBOOK_STORAGE_KEY,
...
export function readLegacyOwnerNotebookNotes({ organizationId = "", userId = "" } = {}) {
...
export function isOwnerNotebookMigrationComplete({ organizationId = "", userId = "" } = {}) {
...
export function markOwnerNotebookMigrationComplete({ organizationId = "", userId = "" } = {}) {
...
export function mergeLegacyOwnerNotebookNotesIntoLocal({ organizationId = "", userId = "" } = {}) {
