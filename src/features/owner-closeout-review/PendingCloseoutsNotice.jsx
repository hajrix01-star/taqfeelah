...
export default function PendingCloseoutsNotice({ lang, pending = [], onView }) {
  ...
  return (
    <div className="mx-2 mb-3 rounded-2xl bg-[#FFF4D2] p-3 ring-1 ring-[#C28A30]/20">
      <p className="text-taq-meta font-black text-[#806528]">{lang === "ar" ? "تقفيلات بانتظار المراجعة" : "Closeouts pending review"}</p>
      ...
      <button type="button" onClick={onView} className="mt-3 w-full rounded-xl bg-[#112A46] py-2.5 text-taq-meta font-black text-white">
