...
> آخر تحديث: **2026-06-08** — PR #89 مدمج؛ التالي PR #90 (مكوّنات العرض).
...
| 7 | **مرحلة لاحقة — PR-4+** *(مجزّأة)* | 🟠 لم ينتهي | جارية — PR #90 |
| 7.0 | ↳ **PR #89 — استخراج مرفقات البروتايب** | ✅ | مدمج `193be00` — نشر VPS |
| 7.0.1 | ↳ **PR #90 — مكوّنات العرض (batch 1)** | 🟠 لم ينتهي | شاشات مالك الإدخال مُستخرَجة محليًا — لم يُرفع بعد |
| 3.2 | ↳ مكوّنات عرضية إضافية | 🟠 لم ينتهي | batch 1: OwnerSummary/Expense — باقي الحوارات لاحقًا |
...
**ملخص سريع:** ✅ **20** بند · 🟠 **9** بنود لم تنتهِ · النشط: **PR #90** (مكوّنات عرضية — لا تغيير UI).
...
```text
المرحلة النشطة: PR-4+ — PR #90 مكوّنات العرض (batch 1)
التقدم الإجمالي:  ████████████████░  #89 مدمج على main (`193be00`)
المرحلة التالية:  تحضير PR #90 → دمج عند طلب صريح
```
...
| PR #90 (entry screens) | 🟡 قيد التحضير | مكوّنات عرضية من Runtime |
